...
meta = read_csv( './martians/martians12px.csv' )
...
(0..999).each do |i|
    num = '%03d' % i
    path = "./martians/hashcheck/#{num}.json"
...
collection = {
  ...
  'banner_image_uri': 'https://github.com/0xCompute/punks12px/raw/master/i/martians12px-banner.png',
  'background_color': '',
  'twitter_link': '',
...
write_json( "./tmp/martians12px.json", collection )
